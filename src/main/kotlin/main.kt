...
//    ui.start()
    ...
    val meals = listOf(
        ...
        Meal(2u,"Chicken Curry",  45u, 102u, LocalDate.parse("2005-09-16"), listOf("curry"),  Nutrition(1f,2f,3f,4f,5f,6f,7f), 6u, listOf("Cook chicken"), "Spicy", listOf("chicken", "spices"), 3u)
        ,Meal(2u,"arriba   baked winter squash mexican style",  45u, 102u, LocalDate.parse("2005-09-16"), listOf("curry"),  Nutrition(1f,2f,3f,4f,5f,6f,7f), 6u, listOf("Cook chicken"), "Spicy", listOf("chicken", "spices"), 3u)
        ,Meal(2u,"arriba   baked winter sqaaah mexican style",  45u, 102u, LocalDate.parse("2005-09-16"), listOf("curry"),  Nutrition(1f,2f,3f,4f,5f,6f,7f), 6u, listOf("Cook chicken"), "Spicy", listOf("chicken", "spices"), 3u)
    )
